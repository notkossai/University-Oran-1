...
{
  "$end", "error", "$undefined", "NUMBER", "SEPR", "'\\n'", "$accept",
  "S", "line", "format", "day", "month", "year", 0
};
#endif
...
#line 29 "syntactic.y"
    {
      int d = atoi((yyvsp[(1) - (5)].str));
      int m = atoi((yyvsp[(3) - (5)].str));
      int y = atoi((yyvsp[(5) - (5)].str));
      
      /* Length check */
      if (strlen((yyvsp[(1) - (5)].str)) != 2) {
          printf("Invalid format: day must be 2 digits\n");
      }
      else if (strlen((yyvsp[(3) - (5)].str)) != 2) {
          printf("Invalid format: month must be 2 digits\n");
      }
      else if (strlen((yyvsp[(5) - (5)].str)) != 4) {
      ...
      free((yyvsp[(1) - (5)].str));  /* Free allocated spaces */
      free((yyvsp[(3) - (5)].str));
      free((yyvsp[(5) - (5)].str));
    ;}
    break;
